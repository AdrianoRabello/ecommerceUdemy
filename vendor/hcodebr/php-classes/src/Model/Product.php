<?php
 ...
 class Product extends Model{
  ...
  public function getCategories(){
    ...
    return $sql->select("SELECT * FROM tb_categories a join tb_productscategories b
                        on a.idcategory = b.idcategory
                        WHERE b.idproduct = :idproduct",[":idproduct"=>$this->getidproduct()]);
  }

  public function deleteFromCategories($idproduct){
    $sql = new Sql();
    $sql->query("DELETE FROM tb_productscategories WHERE idproduct = :idproduct",[":idproduct"=>$idproduct]);
